...
from typing import final, Tuple, List, Iterable, Optional, Mapping, Sequence, Set, Dict, Any, Union
...
class VecGraph(BaseGraph[VT,ET]):
    ...
    def stats(self) -> str: ...
    def copy(self, adjoint:bool=False, backend:Optional[str]=None) -> VecGraph: ...
    def adjoint(self) -> VecGraph: ...
    def map_qubits(self, qubit_map:Mapping[int,Tuple[float,float]]) -> None: ...
    def compose(self, other: VecGraph) -> None: ...
    def tensor(self, other: VecGraph) -> VecGraph: ...
    def __iadd__(self, other: VecGraph) -> VecGraph: ...
    def __add__(self, other: VecGraph) -> VecGraph: ...
    def __mul__(self, other: VecGraph) -> VecGraph: ...
    def __matmul__(self, other: VecGraph) -> VecGraph: ...
    def merge(self, other: VecGraph) -> Tuple[List[VT],List[ET]]: ...
    ...
    def from_tikz(cls, tikz: str, warn_overlap:bool= True, fuse_overlap:bool = True, ignore_nonzx:bool = False) -> VecGraph: ...
    def is_id(self) -> bool: ...
