...
class Decomposer:
    ...
    def __init__(
        ...
        g: VecGraph,
        *,
        use_cats: Optional[bool] = None,
        save: Optional[bool] = None,
        simp: Optional[SimpFunc] = None,
        random_t: Optional[bool] = None,
    ) -> None: ...
    ...
    def random_t(self, b: bool) -> None: ...
    def max_terms(self) -> float: ...
    def decomp_top(self) -> None: ...
    def decomp_all(self) -> None: ...
    def decomp_parallel(self, depth: int, *, allow_threads: bool = True) -> None: ...
    def decomp_until_depth(self, depth: int) -> None: ...
    def use_cats(self, b: bool) -> None: ...
    def pop_graph(self) -> VecGraph: ...
    def split(self) -> list[Decomposer]: ...
    @staticmethod
    def merge(ds: list[Decomposer]) -> Decomposer: ...
