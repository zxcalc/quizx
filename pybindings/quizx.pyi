...
class DecompTree:
    ...
    @classmethod
    def from_list(cls, list: List[Any]) -> DecompTree: ...
    def to_list(self) -> List[Any]: ...
    def add_leaf(self, parent: int, vertex: int) -> int: ...
    def add_interior(self, neighbors: Tuple[int, int, int]) -> int: ...
    def edges(self) -> List[Tuple[int, int]]: ...
    def num_edges(self) -> int: ...
    def path(self, n1: int, n2: int) -> List[int]: ...
    def partition(self, edge: Tuple[int, int]) -> Tuple[List[int], List[int]]: ...
    def compute_ranks(self, graph: VecGraph) -> None: ...
    def rankwidth(self, graph: VecGraph) -> int: ...
    def rankwidth_score(self, graph: VecGraph) -> int: ...
    def contraction_rankwidth(self, graph: VecGraph) -> int: ...
    def contraction_rankwidth_score(self, graph: VecGraph) -> int: ...
    def contraction_rank(self, node: int) -> Optional[int]: ...
    def set_rank(self, edge: Tuple[int, int], rank: int) -> None: ...
    def clear_rank(self, edge: Tuple[int, int]) -> None: ...
    def rank(self, edge: Tuple[int, int]) -> Optional[int]: ...
    def is_valid_for_graph(self, graph: VecGraph) -> bool: ...
    @staticmethod
    def random_decomp(graph: VecGraph, seed: Optional[int] = None) -> DecompTree: ...
    def swap_random_leaves(self, seed: Optional[int] = None) -> None: ...
    def move_random_subtree(self, seed: Optional[int] = None) -> None: ...
    def random_local_swap(self, seed: Optional[int] = None) -> None: ...
    @property
    def num_nodes(self) -> int: ...
    def clone(self) -> DecompTree: ...

@final
class RankwidthAnnealer:
    def __init__(
        self,
        graph: VecGraph,
        seed: Optional[int] = None,
        init_decomp: Optional[DecompTree] = None,
        init_temp: Optional[float] = None,
        min_temp: Optional[float] = None,
        cooling_rate: Optional[float] = None,
        adaptive_cooling: Optional[bool] = None,
        iterations: Optional[int] = None,
        contraction_rankwidth: Optional[bool] = None,
    ) -> None: ...
    @property
    def init_decomp(self) -> DecompTree: ...
    @init_decomp.setter
    def init_decomp(self, value: DecompTree) -> None: ...
    @property
    def init_temp(self) -> float: ...
    @init_temp.setter
    def init_temp(self, value: float) -> None: ...
    @property
    ...
    @property
    def adaptive_cooling(self) -> bool: ...
    @adaptive_cooling.setter
    def adaptive_cooling(self, value: bool) -> None: ...
    @property
    def iterations(self) -> int: ...
    @iterations.setter
    def iterations(self, value: int) -> None: ...
    @property
    def contraction_rankwidth(self) -> bool: ...
    @contraction_rankwidth.setter
    def contraction_rankwidth(self, value: bool) -> None: ...
    def run(self) -> DecompTree: ...
